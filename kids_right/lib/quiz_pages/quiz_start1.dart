...
import 'package:kids_right/true_false/TF1.dart';
...
class _QuizPageState extends State<QuizPage1> {
  final List<Map<String, Object>> questions = [
    {
      'question': 'What does it mean to be treated fairly?',
      'options': [
      ...
      'answer': 'a) With respect and kindness'
    },
    {
      'question':
          'Which Article of the Constitution of India states that everyone is equal in the eyes of the law?',
      'options': [
        'a) Article 14',
        'b) Article 19',
        'c) Article 21',
    ...
    {
      'question': 'Why is the Right to Be Treated Fairly important?',
      'options': [
      ...
      'answer': 'a) To ensure equality'
    },
    {
      'question': 'What should you do if facing discrimination?',
      'options': [
        'a) Stay silent',
    ...
    {
      'question': 'Which is NOT part of being treated fairly?',
      'options': [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TrueFalseGamePage1(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
