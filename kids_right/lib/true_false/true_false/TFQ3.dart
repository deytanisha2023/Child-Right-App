...
class TrueFalseQuizPage3 extends StatefulWidget {
  @override
  _TrueFalseQuizPageState createState() => _TrueFalseQuizPageState();
}

class _TrueFalseQuizPageState extends State<TrueFalseQuizPage3> {
  final List<Map<String, Object>> questions = [
    {
      'question': 'Every child should have a registered name and nationality.',
      'answer': true,
    },
    {
      'question':
          'Children do not have the right to know their parents or guardians.',
      'answer': false,
    },
    {
      'question':
          'Birth registration is important for recognizing a child\'s identity.',
      'answer': true,
    },
    {
      'question': 'Cultural identity is not part of the Right to Identity.',
      'answer': false,
    },
    {
      'question':
          'Legal recognition helps protect children\'s rights and access to services.',
      'answer': true,
    },
  ];
  ...
  void resetQuiz() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => TrueFalseQuizPage3()),
    );
  }
