...
import 'package:kids_right/true_false/TFQ2.dart'; // Import the True/False quiz page

class TrueFalseGamePage2 extends StatelessWidget {
  @override
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TrueFalseQuizPage2(),
                        ),
                      );
                    },
