...
class TrueFalseQuizPage2 extends StatefulWidget {
  @override
  _TrueFalseQuizPageState createState() => _TrueFalseQuizPageState();
}

class _TrueFalseQuizPageState extends State<TrueFalseQuizPage2> {
  final List<Map<String, Object>> questions = [
    {
      'question':
          'Every child can freely share their thoughts, ideas, and feelings.',
      'answer': true,
    },
    {
      'question':
          'The Right to Freedom of Expression allows you to harm others with words.',
      'answer': false,
    },
    {
      'question': 'Children should respect others\' rights and opinions.',
      'answer': true,
    },
    {
      'question': 'You cannot express yourself through art, music, or writing.',
      'answer': false,
    },
    {
      'question':
          'Schools should create safe spaces for children to express themselves.',
      'answer': true,
    },
  ];
  ...
  void resetQuiz() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => TrueFalseQuizPage2()),
    );
  }
