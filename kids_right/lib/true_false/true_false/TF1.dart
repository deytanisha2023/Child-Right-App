...
import 'package:kids_right/true_false/TFQ1.dart'; // Import the True/False quiz page

class TrueFalseGamePage1 extends StatelessWidget {
  @override
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TrueFalseQuizPage1(),
                        ),
                      );
                    },
