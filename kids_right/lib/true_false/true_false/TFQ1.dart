...
class TrueFalseQuizPage1 extends StatefulWidget {
  @override
  _TrueFalseQuizPageState createState() => _TrueFalseQuizPageState();
}

class _TrueFalseQuizPageState extends State<TrueFalseQuizPage1> {
  final List<Map<String, Object>> questions = [
    {
      'question': 'Every child should be treated with respect and kindness.',
      'answer': true,
    },
    {
      'question':
          'Article 14 of the Constitution of India ensures equality for everyone.',
      'answer': true,
    },
    {
      'question': 'Discrimination is acceptable if it\'s based on religion.',
      'answer': false,
    },
    {
      'question':
          'The Right to Be Treated Fairly promotes equality and fairness.',
      'answer': true,
    },
    {
      'question':
          'Ignoring unfair treatment is the best way to handle discrimination.',
      'answer': false,
    },
  ];
  ...
  void resetQuiz() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => TrueFalseQuizPage1()),
    );
  }
